...
public class BulletEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(NonDystopiaModBetaModItems.BULLETITEM.get());

	public BulletEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(NonDystopiaModBetaModEntities.BULLET.get(), world);
	}
	...
	public static BulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BulletEntity entityarrow = new BulletEntity(NonDystopiaModBetaModEntities.BULLET.get(), entity, world);
	...
	public static BulletEntity shoot(LivingEntity entity, LivingEntity target) {
		BulletEntity entityarrow = new BulletEntity(NonDystopiaModBetaModEntities.BULLET.get(), entity, entity.level());

...
public class ModelGstick<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gstick"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone5 = partdefinition.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-0.5F, -0.5F, -0.7048F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 23.5F, -2.2952F));
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -0.1F, -0.15F, 2.0F, 0.2F, 0.3F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, -0.1F, 0.85F, 2.0F, 0.2F, 0.3F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, -0.1F, -1.15F, 2.0F, 0.2F, 0.3F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -1.2F, -0.85F, 0.0F, 0.0F, -0.9163F));

		PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.2F, 0.1F, -1.7F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.6347F, 0.387F, -0.15F, 2.0F, 0.2F, 0.3F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.6347F, 0.387F, 0.85F, 2.0F, 0.2F, 0.3F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.6347F, 0.387F, -1.15F, 2.0F, 0.2F, 0.3F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = partdefinition.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offset(-3.1F, 24.3F, 0.0F));
		...
		PartDefinition bone6 = partdefinition.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offset(-1.2F, 22.0F, -0.2952F));

		PartDefinition cube_r5 = bone6.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(3, 0).addBox(-0.5F, 0.0F, -2.0F, 1.0F, 0.0F, 4.0F,
		...
		PartDefinition cube_r6 = bone6.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(5, 0).addBox(-0.5F, 0.0F, -2.0F, 1.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = partdefinition.addOrReplaceChild("bone7", CubeListBuilder.create(),
				PartPose.offset(-1.1F, 22.65F, -3.35F));

		PartDefinition cube_r7 = bone7.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.1F, -0.05F, -0.55F, 0.2F, 0.1F, 1.1F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.4F, 0.0F, 0.0F, 0.0F, -0.2182F, 0.0F));

		PartDefinition cube_r8 = bone8.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.7F, -0.05F, -0.55F, 0.2F, 0.1F, 1.1F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone10 = partdefinition.addOrReplaceChild("bone10", CubeListBuilder.create(),
				PartPose.offset(-0.5F, 23.3F, -4.15F));

		PartDefinition cube_r9 = bone10.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.1F, -0.15F, 2.0F, 0.2F, 0.3F,
						new CubeDeformation(0.0F)),

...
public class Modeliron_pipe_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "iron_pipe_converted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = group3.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 10)
						.addBox(-0.7F, -0.7F, -0.5F, 1.1F, 0.9F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 10)
						.addBox(-0.7F, -0.4F, 0.1F, 1.1F, 0.9F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -2.1945F, -0.2475F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r2 = group3.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(8, 18).addBox(-0.7F, -0.5F, -0.3F, 1.1F, 1.0F, 0.9F,
		...
		PartDefinition group4 = partdefinition.addOrReplaceChild("group4",
				CubeListBuilder.create().texOffs(12, 0).mirror()
						.addBox(-0.2056F, -2.205F, -0.05F, 1.2F, 10.0F, 0.4F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 0).addBox(0.5944F, -2.205F, -0.85F, 0.4F, 10.0F, 0.8F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-0.2056F, -2.205F, -0.85F, 0.4F, 10.0F, 1.2F, new CubeDeformation(0.0F))
						.texOffs(13, 0).mirror()
		...
		PartDefinition cube_r3 = group.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(-0.2F, 0.6F, -2.5F, 0.4F, 0.9F, 5.0F, new CubeDeformation(0.0F)).texOffs(13, 0).mirror()
						.addBox(-0.9F, 0.6F, -2.5F, 1.1F, 0.4F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.5F, -3.0F, 2.5F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r4 = group.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 11)
				.addBox(-0.35F, -0.25F, -2.5F, 0.4F, 1.2F, 5.0F, new CubeDeformation(0.0F)).texOffs(12, 0).mirror()
				.addBox(-0.35F, -0.25F, -2.5F, 1.2F, 0.4F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
